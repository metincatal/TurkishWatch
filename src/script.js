...
const gridRows = [
    "SAATBİRİBİRE", // Satır 0
    "İKİYİİKİYEON", // Satır 1
    "ÜÇÜÜÇEDÖRTVK", // Satır 2
    "DÖRDÜDÖRDEZM", // Satır 3
    "BEŞİBEŞEVBEŞ", // Satır 4
    "ALTIYIALTIYA", // Satır 5
    "YEDİYİYEDİYE", // Satır 6
    "SEKİZİSEKİZE", // Satır 7
    "DOKUZUDOKUZA", // Satır 8
    "ONUONAFYİRMİ", // Satır 9
    "ÇEYREKOBUÇUK", // Satır 10
    "VARLGEÇİYORT", // Satır 11
];
...
// Saatler için [satır, başlangıç, bitiş] listesi (Birden fazla kelimeden oluşabiliyor, ör: ON BİR)
...
// Birden fazla bölümden oluşan koordinat listesini yak (Örn: ON BİR)
