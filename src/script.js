...
const HOURS_NOMINATIVE = {
    1: [[6, 5, 8]], 2: [[4, 6, 10]], 3: [[6, 9, 11]], 4: [[5, 5, 9]],
    5: [[7, 4, 7]], 6: [[0, 5, 10]], 7: [[1, 6, 11]], 8: [[2, 6, 11]],
    9: [[3, 6, 11]], 10: [[8, 0, 2]], 11: [[8, 0, 2], [6, 5, 8]], 12: [[8, 0, 2], [4, 6, 10]]
};
...
const HOURS_DATIVE = {
    1: [[7, 0, 3]], 2: [[5, 0, 4]], 3: [[8, 6, 8]], 4: [[6, 0, 4]],
    5: [[7, 8, 11]], 6: [[1, 0, 5]], 7: [[2, 0, 5]], 8: [[3, 0, 5]],
    9: [[4, 0, 5]], 10: [[8, 3, 5]], 11: [[8, 0, 2], [7, 0, 3]], 12: [[8, 0, 2], [5, 0, 4]]
};
